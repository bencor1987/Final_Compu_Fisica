                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>Selector múltiple color celeste</label>
                                            <div class="select2-lightblue">
                                                <select class="select2" multiple="multiple" data-placeholder="Seleccione un Estado" data-dropdown-css-class="select2-lightblue" style="width: 100%;">
                                                    <option>Alabama</option>
                                                    <option>Alaska</option>
                                                    <option>California</option>
                                                    <option>Delaware</option>
                                                    ...
                                                    <option>Texas</option>
                                                    <option>Washington</option>
                                                    <option>Alabama nro 2</option>
                                                    <option>Alabama nro 3</option>
                                                    <option>Alabama nro 4</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
