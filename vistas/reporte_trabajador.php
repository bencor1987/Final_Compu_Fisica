...
if (!isset($_SESSION['user'])) {
    ...
    $id_trab = $_GET['idtra'];
    $query = "SELECT CONCAT(nombre, ' ', apellido) FROM trabajador WHERE id_trabajador = $id_trab";
    ...
    <html lang="es">
        <head>
            ...
            <title>SIS | Anti Covid -- Reporte de <?php echo $nombre; ?></title>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header card-info card-outline">
                                            <h4>Registro de <?php echo $nombre ?></h4>
                                        </div>
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $consulta = "SELECT id_registro_covid,temperatura,hora_ingreso,fecha FROM registro_covid WHERE id_trabajador = $id_trab";
                                                    $peticion = mysqli_query($conexion, $consulta);
                                                    while ($ver = mysqli_fetch_row($peticion)) {
